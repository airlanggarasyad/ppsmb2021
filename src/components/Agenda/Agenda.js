    ...
    <AgendaStyle>
      <div className="bg-container">
        <div className="bg-content">
          ...
          <div className="batik-right">
            <img src={batikRight} alt="" />
          </div>
          <div className="batik-left">
            <img src={batikLeft} alt="" />
          </div>
        </div>
      </div>
      <div className="agenda-container">
        ...
        <div className="card-grid">
          <Card day="one"></Card> <Card day="two"></Card>{" "}
          <Card day="three"></Card> <Card day="four"></Card>{" "}
          <Card day="five"></Card> <Card day="six"></Card>
        </div>
      </div>
    </AgendaStyle>
  );
